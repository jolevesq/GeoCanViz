    ...
    define(['gcviz-vm-help'
        ...
        getKeyHelp = function() {
            ...
            node = '<section id="gcviz-help-key" class="gcviz-help gcviz-help-key">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: keyTitle"></span></div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: keyFocusNextTitle"></span>' +
                            '<span class="gcviz-span9" data-bind="text: keyFocusNext"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: keyFocusPrevTitle"></span>' +
                            '<span class="gcviz-span9" data-bind="text: keyFocusPrev"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: keyZoomTitle"></span>' +
                            '<span class="gcviz-span9" data-bind="text: keyZoom"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: keyPanTitle"></span>' +
                            '<span class="gcviz-span9" data-bind="text: keyPan"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: keyEnterTitle"></span>' +
                            '<span class="gcviz-span9" data-bind="text: keyEnter"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: keySpaceTitle"></span>' +
                            '<span class="gcviz-span9" data-bind="text: keySpace"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: keyWCAGTitle"></span>' +
                            '<span class="gcviz-span9" data-bind="text: keyWCAG"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<span class="gcviz-span12" data-bind="text: keyPref"></span>' +
                        '</div>' +
                    '</section>';
        ...
        getMapTools = function(config) {
            ...
            if (zoommax || zoombar || zoom || previousnext) {
                node = '<section id="gcviz-help-map" class="gcviz-help gcviz-help-map">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: mapTitle"></span></div>';

                if (zoommax) {
                    node +='<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                                    '<button class="gcviz-help-zoommax" tabindex="-1"></button>' +
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: mapZoomFull"></span>' +
                            '</div>';
                }
                ...
                if (zoombar) {
                    node += '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: mapZoombar"></span>' +
                            '</div>';
                }
                ...
                if (zoom) {
                    node += '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: mapZoom"></span>' +
                            '</div>';
                }

                if (previousnext) {
                    node += '<div class="gcviz-row">' +
                                '<div class="gcviz-span2">' +
                                    '<button class="gcviz-help-zoomp" tabindex="-1"></button>' +
                                    '<button class="gcviz-help-zoomn" tabindex="-1"></button>' +
                                '</div>' +
                                '<span class="gcviz-span10 gcviz-help-textbtn" data-bind="text: mapZoompv"></span>' +
                            '</div>';
                }
        ...
        getHeaderHelp = function(config) {
            ...
            node = '<section id="gcviz-help-head" class="gcviz-help gcviz-help-head">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: headTitle"></span></div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span1">' +
                                '<button class="gcviz-help-help" tabindex="-1"></button>' +
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: headHelp"></span>' +
                        '</div>';
            ...
            if (about) {
                node += '<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: headAbout"></span>' +
                        '</div>';
            }
            ...
            if (print) {
                node += '<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: headPrint"></span>' +
                        '</div>';
            }
            ...
            if (saveimage) {
                node += '<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: headSaveImg"></span>' +
                        '</div>';
            }
            ...
            if (saveurl) {
                node += '<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: headSaveUrl"></span>' +
                        '</div>';
            }
            ...
            if (fullscreen) {
                node += '<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: headGoFS"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span1">' +
                                '<button class="gcviz-help-reg" tabindex="-1"></button>' +
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: headExitFS"></span>' +
                        '</div>';
            }

            if (menu) {
                node += '<div class="gcviz-row">' +
                            '<span class="gcviz-span1 gcviz-help-textsub" data-bind="text: headMenuTitle"></span>' +
                            '<span class="gcviz-span11" data-bind="text: headMenu"></span>' +
                        '</div>';
            }
        ...
        getFooterHelp = function(config) {
            ...
            if (arrow || coord || scale) {
                node = '<section id="gcviz-help-foot" class="gcviz-help gcviz-help-foot">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: footTitle"></span></div>';

                if (scale) {
                    node += '<div class="gcviz-row">' +
                                '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: footScalebarTitle"></span>' +
                                '<span class="gcviz-span9" data-bind="text: footScalebar"></span>' +
                            '</div>';
                }

                if (coord) {
                    node += '<div class="gcviz-row">' +
                                '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: footCoordTitle"></span>' +
                                '<span class="gcviz-span9" data-bind="text: footCoord"></span>' +
                            '</div>';
                }
                ...
                if (arrow) {
                    node += '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: footArrow"></span>' +
                            '</div>';
                }
        ...
        getDrawHelp = function(config) {
            ...
            if (enable && (drawline || drawtext || measline || measarea || impexp)) {
                node = '<section id="gcviz-help-tbdraw" class="gcviz-help gcviz-help-tbdraw">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: drawTitle"></span></div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span3 gcviz-draw-cholder">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span9" data-bind="text: drawColorSelect"></span>' +
                        '</div>';
                ...
                node +=	'<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11" data-bind="text: drawEraseAll"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span1">' +
                        ...
                        '<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11" data-bind="text: drawUndo"></span>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span1">' +
                                '<button class="gcviz-help-redo" tabindex="-1"></button>' +
                            '</div>' +
                            '<span class="gcviz-span11" data-bind="text: drawRedo"></span>' +
                        '</div>';
                ...
                if (impexp) {
                    node += '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: drawImport"></span>' +
                            '</div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                                    '<button class="gcviz-help-exp" tabindex="-1"></button>' +
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: drawExport"></span>' +
                            '</div>';
                }
                ...
                if (about) {
                    node += '<div class="gcviz-row">' +
                            '<div class="gcviz-span1">' +
                                '<button class="gcviz-help-about" tabindex="-1"></button>' +
                            '</div>' +
                            '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: legAbout"></span>' +
                        '</div>';
                }

                node +=	'<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: legDesc1"></span></div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span1">' +
                                '<img class="gcviz-foot-logo" data-bind="attr: { src: imgHelpRadio, alt: legRadioAlt }" tabindex="-1"></img>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span11" data-bind="text: legDesc2"></span></div>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span1">' +
                                '<img class="gcviz-foot-logo" data-bind="attr: { src: imgHelpChk, alt: legChkAlt }" tabindex="-1"></img>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span11" data-bind="text: legDesc3"></span></div>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span2">' +
                                '<img class="gcviz-foot-logo" data-bind="attr: { src: imgHelpSlider, alt: legSliderAlt }" tabindex="-1"></img>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span10" data-bind="text: legSlider"></span></div>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span2">' +
                                '<img class="gcviz-foot-logo" data-bind="attr: { src: imgHelpArrow, alt: legArrowAlt }" tabindex="-1"></img>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span10" data-bind="text: legExpand"></span></div>' +
                        '</div>' +
                        '<div class="gcviz-row">' +
                            '<div class="gcviz-span5">' +
                                '<img class="gcviz-foot-logo" data-bind="attr: { src: imgHelpAddFile, alt: legAddFileAlt }" tabindex="-1"></img>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span7" data-bind="text: legNewLayer"></span></div>' +
                        '</div>' +
                    '</section>';
            }
        ...
        getNavHelp = function(config) {
            ...
            if (enable && (zoom || info || ov || scale)) {
                node = '<section id="gcviz-help-tbnav" class="gcviz-help gcviz-help-tbnav">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: navTitle"></span></div>';

                if (zoom) {
                    node += '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: navZoomtoTitle"></span></div>' +
                            '<div class="gcviz-row">' +
                ...
                if (info) {
                    node += '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: navMapInfoTitle"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                ...
                if (ov) {
                    node += '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: navAltOV"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span6">' +
                                    '<img class="gcviz-help-img" data-bind="attr: { src: imgHelpOV, title: navAltOV }"></img>' +
                                '</div>' +
                                '<span class="gcviz-span6" data-bind="text: navOV"></span>' +
                            '</div>';
                }

                if (scale) {
                    node += '<div class="gcviz-row">' +
                                '<span class="gcviz-span3 gcviz-help-textsub" data-bind="text: navScaleTitle"></span>' +
                                '<span class="gcviz-span9" data-bind="text: navScale"></span>' +
                            '</div>';
                }
        ...
        getDataHelp = function(config) {
            ...
            if (enable) {
                node = '<section id="gcviz-help-tbdata" class="gcviz-help gcviz-help-tbdata">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: dataTitle"></span></div>';
                ...
                if (datafile) {
                    node += '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: dataAddFile"></span>' +
                            '</div>';
                }
                ...
                if (dataurl) {
                    node += '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                                    '<button class="gcviz-help-adddata" tabindex="-1"></button>' +
                                '</div>' +
                                '<span class="gcviz-span11" data-bind="text: dataAddURL"></span>' +
                            '</div>';
                }

                node += '<div class="gcviz-row">' +
                                '<div class="gcviz-span12">' +
            ...
            if (enable) {
                node = '<section id="gcviz-help-tbextract" class="gcviz-help gcviz-help-tbextract">' +
                        '<div class="gcviz-row">' +
                            ...
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: extDesc1"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                                    '<button class="gcviz-help-pos" tabindex="-1"></button>' +
                                '</div>' +
                                '<span class="gcviz-span11 gcviz-help-textbtn" data-bind="text: extClick"></span>' +
                            '</div>' +
                            '<div class="gcviz-row">' +
                                '<span class="gcviz-span11" data-bind="text: extLink"></span>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: extDesc2"></span></div>' +
                        '</div>';
        ...
        getDatagridHelp = function(config) {
            ...
            if (enable) {
                node = '<section id="gcviz-help-datagrid" class="gcviz-help gcviz-help-datagrid">' +
                            ...
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgDesc1"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgDesc2"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgDesc3"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgDesc4"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgDesc5"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: dgZoomTitle"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgZoomSelDesc"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                            ...
                            '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: dgFilterTitle"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgFilterDesc"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                                ...
                                '</div>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgFilterTypeDesc"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                            ...
                            '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: dgLinkTitle"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgLinkDesc"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                            ...
                            '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: dgExportTitle"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                                ...
                                '</div>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-help-textsub" data-bind="text: dgPopTitle"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgPopDesc1"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgPopDesc2"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgPopDesc3"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgPopDesc4"></span></div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgPopDesc5"></span></div>' +
                            '<div class="gcviz-row">' +
                                '<div class="gcviz-span1">' +
                            ...
                            '<div class="gcviz-row">' +
                                ...
                                '</div>' +
                            '</div>' +
                            '<div class="gcviz-row"><span class="gcviz-span12" data-bind="text: dgPopDesc6"></span></div>';
        ...
        getDevHelp = function(config) {
            ...
            node = '<section id="gcviz-help-dev" class="gcviz-help gcviz-help-dev">' +
                        '<div class="gcviz-row"><span class="gcviz-help-tbtitle" data-bind="text: devTitle"></span></div>';
            ...
            if (config.logo) {
                node += '<div class="gcviz-row">' +
                            ...
                            '</div>' +
                            '<span class="gcviz-span11" data-bind="text: devLogo"></span>' +
                        '</div>';
            }

            node +='<div class="gcviz-row"><span data-bind="text: devDesc"></span>' +
